...
LOCAL_APPS = [
    ...
    # custom users app
    "everynote.notes.apps.NotesConfig",
    # note info app
]
...
MIGRATION_MODULES = {
    "sites": "everynote.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "everynote.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("opMaia", "opmaia@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "everynote.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "everynote.users.adapters.SocialAccountAdapter"
)
