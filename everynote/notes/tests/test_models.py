...
#opMaia-ini
    ...
    print("\t\t10:*** Estou em test___str__ do aq /tests/test-models.py\n")
#opMaia-fim
    # Del (vide pg 192)
    ...
    # Add (vide pg 192)
    note = NoteFactory()
    print("\t\t12:*** Estou em test___str__ do aq /tests/test-models.py\n")
...
#opMaia-ini
	# Esta classe valida o cpo firmness de um note
    print("\t\t10:*** Estou em test_get_absolute_url do aq /tests/test-models.py\n")
#opMaia-fim
    note = NoteFactory()
